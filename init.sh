...
sed -i "s/{your-secrets-here}/$secret/g" prod.json # Chage user name to empty string
...
sed -i "s/{your-secrets-here}/$secret/g" test.json # Chage user name to empty string
